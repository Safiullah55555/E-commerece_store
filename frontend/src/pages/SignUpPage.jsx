        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div>
            ...
            <button
							...
							rounded-md shadow-sm text-sm font-medium text-black bg-[#fed813]
							 hover:bg-[#febd69] focus:outline-none focus:ring-2 focus:ring-offset-2
